...
(function voronoi() {
  ...
  d3.csv('penguins.csv').then(data => {
    ...
    cellGroups.append("path")
    // can further modify to localize the regions more (so no tooltip when you're in the corner far from any point)
      .attr("d", (d, i) => voronoi.renderCell(i))
      .attr("fill-opacity", 0)
      .attr("stroke", "black") // comment this line to hide the voronoi cells
