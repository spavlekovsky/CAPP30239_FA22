...
(function symbol() {
  // making an immediately invoked function (you know this because of the parentheses at beginning an end)
  // in order to isolate the two charts 
  let height = 400,
      width = 600,
  ...
  d3.csv('penguins.csv').then(data => {
    ...
    svg.append("g")
        .selectAll(".cross") // select here then set later
        .data(data)
        .join("path") // symbols are considered paths, while dots are circles
